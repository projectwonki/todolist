            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center space-x-4">
                        ...
                        <h1 class="text-xl font-semibold text-slate-900 dark:text-slate-50">Edit Tugas</h1>
                    </div>
                    <div class="flex items-center space-x-4">
                ...
                <div class="p-6">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500 dark:text-slate-400">Perbarui informasi tugas di bawah ini</p>
                        </div>
                    </div>

                    <form method="POST" action="{{ route('tasks.update', $task->id) }}" id="task-form" class="space-y-6">
                        @csrf
                        @method('PUT')
            ...
            <div class="mt-6 rounded-lg border border-slate-200 bg-slate-50 text-slate-950 shadow-sm dark:border-slate-800 dark:bg-slate-900 dark:text-slate-50">
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h3 class="text-sm font-medium text-slate-900 dark:text-slate-50 mb-1">Tips Edit Tugas</h3>
                            <ul class="text-sm text-slate-600 dark:text-slate-300 space-y-1">
                                <li>• <strong>Status</strong>: Perbarui status sesuai progress tugas saat ini</li>
                                <li>• <strong>Batas Waktu</strong>: Sesuaikan deadline jika diperlukan</li>
                                <li>• <strong>Deskripsi</strong>: Tambahkan detail progress atau catatan penting</li>
                                <li>• <strong>Judul</strong>: Perjelas judul tugas jika perlu</li>
                            </ul>
                        </div>
                    </div>
                </div>
